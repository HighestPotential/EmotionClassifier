...
def main():
    ...
    comparison_dir = r"C:\Users\drnes\OneDrive\Desktop\PC\Aleks\Aleks Uni\Computer Vision\Final_Project\EmotionClassifier\EmotionClassifier-aleks\models\aleks\Comparison\AdamW_weighted_cross_entropy"
    ...
    csv_path = os.path.join(comparison_dir, "results_AdamW_weighted_cross_entropy.csv")
