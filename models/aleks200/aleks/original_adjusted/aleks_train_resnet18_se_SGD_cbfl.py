...
def main():
    ...
    best_eval = 0.0
    best_train = 0.0
    best_path = os.path.join(weights_dir, "best_resnet18_se_SGD_cbfl.pth")
    checkpoint_path = os.path.join(weights_dir, "checkpoint_resnet18_se_SGD_cbfl.pth")
    
    # CSV file setup
    csv_path = os.path.join(results_dir, "results_SGD_class_balanced_focal_loss.csv")
