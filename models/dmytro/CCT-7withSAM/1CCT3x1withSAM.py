...
try:
    from src.cct import cct_7_3x1_32
except ImportError:
    print("Wait, still couldn't import src. Please verify the symlink or path.")
...
# writer = SummaryWriter(f'runs/emotion_cct_{timestamp}')
...
for epoch in range(EPOCHS):
    ...
    # Checkpoint
    model_path = f'models/dmytro/CCT-7withSAM/model_checkpoint_epoch_{epoch+1}.pth'
