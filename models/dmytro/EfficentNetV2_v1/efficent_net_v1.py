...
if __name__ == '__main__':
    ...
    save_dir = '/home/d/dumanskyy/work/EmotionClassifier/models/dmytro/EfficentNetV2_v1/'
    os.makedirs(save_dir, exist_ok=True)

    # --- CSV Logging Setup ---
    csv_path = os.path.join(save_dir, 'efficientnetv1_results.csv')
    ...
    for epoch in range(start_epoch, EPOCHS):
        ...
        if val_acc > best_val_acc:
            ...
            }, os.path.join(save_dir, 'efficientnetv1_best.pth'))
        ...
        torch.save({
            ...
            'model_ema_state_dict': model_ema.module.state_dict(),
            'best_acc': best_val_acc
        }, os.path.join(save_dir, 'efficientnetv1_last.pth'))
