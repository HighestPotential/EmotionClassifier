...
def main():
    ...
    checkpoint_path = save_dir / "best_modelCERNA3WithoutCKetc.pt"
    ...
    if checkpoint_path.exists():
        ...
        try:
            ...
            best_eval_acc = checkpoint.get("best_eval_acc", 0.0)

            print(f"Resuming from epoch {start_epoch}")
            print(f"Best validation accuracy: {best_eval_acc:.2f}")

        except Exception as e:
            print("Checkpoint failed or missing keys:", e)
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if eval_acc > best_eval_acc:
                ...
                torch.save(
                    model.state_dict(),
                    save_dir / "best_modelCERNA3WithoutCKetcCorrect.pt"
                )
